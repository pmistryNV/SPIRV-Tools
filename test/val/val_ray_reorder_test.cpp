...
using ValidateRayReorderNV = spvtest::ValidateBase<bool>;
...
std::string GenerateReorderThreadCode(
  ...
  ss << R"(
            ...
            OpCapability ShaderExecutionReorderNV
            OpExtension "SPV_KHR_ray_tracing"
            OpExtension "SPV_NV_shader_execution_reorder"
       %1 = OpExtInstImport "GLSL.std.450"
            OpMemoryModel Logical GLSL450
            OpEntryPoint RayGenerationNV %main "main" %hObj
            OpSourceExtension "GL_EXT_ray_tracing"
            OpSourceExtension "GL_NV_shader_execution_reorder"
            OpName %main "main"
    %void = OpTypeVoid
...
TEST_F(ValidateRayReorderNV, ReorderThreadWithHintNV) {
...
TEST_F(ValidateRayReorderNV, ReorderThreadWithHitObjectNV) {
  const std::string declarations = R"(
      %uint = OpTypeInt 32 0
    %uint_4 = OpConstant %uint 4
...
TEST_F(ValidateRayReorderNV, HitObjectTraceRayNV) {
  const std::string declarations = R"(
       %uint = OpTypeInt 32 0
...
TEST_F(ValidateRayReorderNV, HitObjectTraceRayMotionNV) {
  const std::string declarations = R"(
        %uint = OpTypeInt 32 0
      %uint_1 = OpConstant %uint 1
     %v3float = OpTypeVector %float 3
...
TEST_F(ValidateRayReorderNV, HitObjectRecordHitNV) {
  const std::string declarations = R"(
        %int_1 = OpConstant %int 1
        %uint = OpTypeInt 32 0
      %uint_2 = OpConstant %uint 2
...
TEST_F(ValidateRayReorderNV, HitObjectRecordHitWithIndexNV) {
  const std::string declarations = R"(
        %int_1 = OpConstant %int 1
        %uint = OpTypeInt 32 0
      %uint_2 = OpConstant %uint 2
...
TEST_F(ValidateRayReorderNV, HitObjectRecordEmptyNV) {
  const std::string body = R"(
...
TEST_F(ValidateRayReorderNV, HitObjectRecordMissNV) {
  const std::string declarations = R"(
         %uint = OpTypeInt 32 0
       %uint_1 = OpConstant %uint 1
      %v3float = OpTypeVector %float 3
...
TEST_F(ValidateRayReorderNV, HitObjectIsHitNV) {
  const std::string declarations = R"(
        %bool = OpTypeBool
...
TEST_F(ValidateRayReorderNV, HitObjectGetRayTMaxNV) {
  const std::string declarations = R"(
...
TEST_F(ValidateRayReorderNV, HitObjectGetRayTMinNV) {
  const std::string declarations = R"(
        %_ptr_Function_float = OpTypePointer Function %float
  )";
...
TEST_F(ValidateRayReorderNV, HitObjectGetWorldRayOriginNV) {
  const std::string declarations = R"(
        %v3float = OpTypeVector %float 3
...
TEST_F(ValidateRayReorderNV, HitObjectGetObjectRayOriginNV) {
  const std::string declarations = R"(
        %v3float = OpTypeVector %float 3
        %_ptr_Function_v3float = OpTypePointer Function %v3float
  )";
...
TEST_F(ValidateRayReorderNV, HitObjectGetWorldRayDirectionNV) {
  const std::string declarations = R"(
        %v3float = OpTypeVector %float 3
        %_ptr_Function_v3float = OpTypePointer Function %v3float
  )";
...
TEST_F(ValidateRayReorderNV, HitObjectGetObjectRayDirectionNV) {
  const std::string declarations = R"(
        %v3float = OpTypeVector %float 3
        %_ptr_Function_v3float = OpTypePointer Function %v3float
  )";
...
TEST_F(ValidateRayReorderNV, HitObjectGetObjectToWorldNV) {
  const std::string declarations = R"(
        %v3float = OpTypeVector %float 3
...
TEST_F(ValidateRayReorderNV, HitObjectGetWorldToObjectNV) {
  const std::string declarations = R"(
        %v3float = OpTypeVector %float 3
        %mat4v3float = OpTypeMatrix %v3float 4
        %_ptr_Function_mat4v3float = OpTypePointer Function %mat4v3float
...
TEST_F(ValidateRayReorderNV, HitObjectGetInstanceCustomIndexNV) {
  const std::string declarations = R"(
...
TEST_F(ValidateRayReorderNV, HitObjectGetInstanceIdNV) {
  const std::string declarations = R"(
        %_ptr_Function_int = OpTypePointer Function %int
  )";
...
TEST_F(ValidateRayReorderNV, HitObjectGetPrimitiveIndexNV) {
  const std::string declarations = R"(
        %_ptr_Function_int = OpTypePointer Function %int
  )";
...
TEST_F(ValidateRayReorderNV, HitObjectGetGeometryIndexNV) {
  const std::string declarations = R"(
        %_ptr_Function_int = OpTypePointer Function %int
  )";
...
TEST_F(ValidateRayReorderNV, HitObjectGetHitKindNV) {
  const std::string declarations = R"(
    %uint = OpTypeInt 32 0
...
TEST_F(ValidateRayReorderNV, HitObjectGetAttributesNV) {
  const std::string body = R"(
...
TEST_F(ValidateRayReorderNV, HitObjectGetShaderRecordBufferHandleNV) {
  const std::string declarations = R"(
           %uint = OpTypeInt 32 0
...
TEST_F(ValidateRayReorderNV, HitObjectGetShaderBindingTableRecordIndexNV) {
  const std::string declarations = R"(
    %uint = OpTypeInt 32 0
    %_ptr_Function_uint = OpTypePointer Function %uint
  )";
